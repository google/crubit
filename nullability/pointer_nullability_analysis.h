...
class PointerNullabilityAnalysis
 ...
 public:
  ...
  // at destructor entry (see
  // `PointerNullabilityLattice::NonFlowSensitiveState::FieldsToTreatAsNullableAtDestructorEntry`).
  // Should be called before running the analysis.
