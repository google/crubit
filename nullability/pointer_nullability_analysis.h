...
class PointerNullabilityAnalysis
 ...
 public:
  ...
  // Installs the flow-narrowed nullability of by-value captured pointer
  // variables to model at lambda call-operator entry, as proven at the capture
  // site in the enclosing function. Should be called before running the
