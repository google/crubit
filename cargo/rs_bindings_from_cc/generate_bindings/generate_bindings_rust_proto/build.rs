...
fn main() {
    println!("cargo:rerun-if-changed=../../../../rs_bindings_from_cc/generate_bindings/generate_bindings.proto");
    let out_dir = std::env::var("OUT_DIR").unwrap();
    let mut codegen = protobuf_codegen::CodeGen::new();
    codegen
        .output_dir(&out_dir)
        .input("generate_bindings.proto")
        .include("../../../../rs_bindings_from_cc/generate_bindings")
        .include("../../../..")
        .include("../../../../..")
        .include("../../../../../..");
    ...
    let generated_path = format!("{out_dir}/generate_bindings.u.pb.rs");
    let target_path = format!("{out_dir}/generate_bindings.rs");
