...
use rustc_hir::{HirId, Item, ItemKind, Node, Safety, UseKind, UsePath};
...
struct BridgedType {
    cpp_type: CcType,
    cpp_type_include: Symbol,
    conversion_info: BridgedTypeConversionInfo,
}

enum BridgedTypeConversionInfo {
