    ...
    test_format_item(test_src, "foo", |result| {
        ...
        assert_cc_matches!(
            ...
            quote! {
                ...
                foo(std::int32_t const* [[clang::annotate_type("lifetime", "__anon1")]] absl_nonnull arg ABSL_ATTRIBUTE_LIFETIME_BOUND);
            }
        );
        assert_cc_matches!(
            result.cc_details.tokens,
            quote! {
                ...
                extern "C"
                std::int32_t const& [[clang::annotate_type("lifetime", "__anon1")]] ...(
                    std::int32_t const* [[clang::annotate_type("lifetime", "__anon1")]] absl_nonnull);
                }
                inline
                std::int32_t const& [[clang::annotate_type("lifetime", "__anon1")]]
                foo(std::int32_t const* [[clang::annotate_type("lifetime", "__anon1")]] absl_nonnull arg ABSL_ATTRIBUTE_LIFETIME_BOUND) {
    ...
    test_format_item(test_src, "foo", |result| {
        ...
        assert_cc_matches!(
            ...
            quote! {
              ...
              foo(
                std::int32_t const* [[clang::annotate_type("lifetime", "a")]] absl_nonnull arg1,
                std::int32_t const* [[clang::annotate_type("lifetime", "foo")]] absl_nonnull arg2,
                std::int32_t const* [[clang::annotate_type("lifetime", "foo")]] absl_nonnull arg3,
                std::int32_t const* [[clang::annotate_type("lifetime", "static")]] absl_nonnull arg4,
        ...
        assert_cc_matches!(
            ...
            quote! {
                ...
                std::int32_t const& [[clang::annotate_type("lifetime", "foo")]]
                ...(
                    std::int32_t const* [[clang::annotate_type("lifetime", "a")]] absl_nonnull,
                    std::int32_t const* [[clang::annotate_type("lifetime", "foo")]] absl_nonnull,
                    std::int32_t const* [[clang::annotate_type("lifetime", "foo")]] absl_nonnull,
                    std::int32_t const* [[clang::annotate_type("lifetime", "static")]] absl_nonnull,
                    std::int32_t const&,
                    std::int32_t const&);
                }
                inline
