...
#[test]
fn test_unmovable_result_param_wrapped_in_movable() {
    let test_src = r#"
            pub struct Unmovable {
                pub x: i32,
            }
    ...
    test_format_item(test_src, "pass_unmovable_result", |result| {
        ...
        assert_cc_matches!(
            result.main_api.tokens,
            quote! {
                void pass_unmovable_result(::rs::Movable<rs_std::Result<rs_std::unit_t, ::rust_out::Unmovable>> _x);
            }
        );
        assert_cc_matches!(
            result.cc_details.tokens,
            quote! {
                inline void pass_unmovable_result(::rs::Movable<rs_std::Result<rs_std::unit_t, ::rust_out::Unmovable>> _x) {
...
#[test]
fn test_unmovable_result_ok_param_wrapped_in_movable() {
    let test_src = r#"
            pub struct Unmovable {
                pub x: i32,
            }
            ...
            pub fn pass_unmovable_result_ok(_x: Result<Unmovable, i32>) {}
        "#;
    test_format_item(test_src, "pass_unmovable_result_ok", |result| {
        let result = result.unwrap().unwrap();
        assert_cc_matches!(
            result.main_api.tokens,
            quote! {
                void pass_unmovable_result_ok(::rs::Movable<rs_std::Result<::rust_out::Unmovable, ::std::int32_t>> _x);
            }
        );
        assert_cc_matches!(
            result.cc_details.tokens,
            quote! {
                inline void pass_unmovable_result_ok(::rs::Movable<rs_std::Result<::rust_out::Unmovable, ::std::int32_t>> _x) {
                    crubit::Slot<rs_std::Result<::rust_out::Unmovable, ::std::int32_t>> _x_slot;
                    ::std::move(_x).MoveToSlot(_x_slot);
                    return __crubit_internal::__crubit_thunk_pass_uunmovable_uresult_uok(_x_slot.Get());
                }
            }
        );
    });
...
#[test]
fn test_unmovable_result_both_param_wrapped_in_movable() {
    let test_src = r#"
            pub struct Unmovable {
                pub x: i32,
            }
            ...
            pub fn pass_unmovable_result_both(_x: Result<Unmovable, Unmovable>) {}
        "#;
    test_format_item(test_src, "pass_unmovable_result_both", |result| {
        let result = result.unwrap().unwrap();
        assert_cc_matches!(
            result.main_api.tokens,
            quote! {
                void pass_unmovable_result_both(::rs::Movable<rs_std::Result<::rust_out::Unmovable, ::rust_out::Unmovable>> _x);
            }
        );
        assert_cc_matches!(
            result.cc_details.tokens,
            quote! {
                inline void pass_unmovable_result_both(::rs::Movable<rs_std::Result<::rust_out::Unmovable, ::rust_out::Unmovable>> _x) {
                    crubit::Slot<rs_std::Result<::rust_out::Unmovable, ::rust_out::Unmovable>> _x_slot;
                    ::std::move(_x).MoveToSlot(_x_slot);
                    return __crubit_internal::__crubit_thunk_pass_uunmovable_uresult_uboth(_x_slot.Get());
                }
            }
        );
    });
...
#[test]
fn test_unmovable_result_in_tuple_param() {
    let test_src = r#"
            pub struct Unmovable {
                pub x: i32,
            }
            ...
            pub fn pass_unmovable_result_tuple(_x: (Result<(), Unmovable>,)) {}
        "#;
    test_format_item(test_src, "pass_unmovable_result_tuple", |result| {
        let result = result.unwrap().unwrap();
        assert_cc_matches!(
            result.main_api.tokens,
            quote! {
                void pass_unmovable_result_tuple(::std::tuple<::rs::Movable<rs_std::Result<rs_std::unit_t, ::rust_out::Unmovable>>> _x);
            }
        );
    });
}
...
#[test]
fn test_unmovable_result_in_tuple_return() {
    let test_src = r#"
            pub struct Unmovable {
                pub x: i32,
            }
            ...
            pub fn return_unmovable_result_tuple() -> (Result<(), Unmovable>,) {
                loop {}
            }
        "#;
    test_format_item(test_src, "return_unmovable_result_tuple", |result| {
        let result = result.unwrap().unwrap();
        assert_cc_matches!(
            result.main_api.tokens,
            quote! {
                ::std::tuple<::rs::Movable<rs_std::Result<rs_std::unit_t, ::rust_out::Unmovable>>> return_unmovable_result_tuple();
            }
        );
        assert_cc_matches!(
            result.cc_details.tokens,
            quote! {
                inline ::std::tuple<::rs::Movable<rs_std::Result<rs_std::unit_t, ::rust_out::Unmovable>>> return_unmovable_result_tuple() {
                    crubit::Slot<rs_std::Result<rs_std::unit_t, ::rust_out::Unmovable>> __return_value_0_ret_val_holder;
                    auto* __return_value_0_storage = __return_value_0_ret_val_holder.Get();
                    void* __return_value_storage[] = { __return_value_0_storage };
                    __crubit_internal::__crubit_thunk_return_uunmovable_uresult_utuple(__return_value_storage);
                    return ::std::make_tuple(::rs::Movable<rs_std::Result<rs_std::unit_t, ::rust_out::Unmovable>>::TakeFromSlot(::std::move(__return_value_0_ret_val_holder)));
                }
            }
        );
    });
