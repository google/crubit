...
const _: () = assert!(::core::mem::offset_of!((i8, isize,), 1) == 8);
#[unsafe(no_mangle)]
...
const _: () = assert!(::core::mem::offset_of!((isize, i8,), 1) == 8);
#[unsafe(no_mangle)]
...
const _: () = assert!(::core::mem::offset_of!((::tuples_golden::HasDefault, u8,), 1) == 24);
const _: () = assert!(::core::mem::offset_of!((::tuples_golden::HasNoDefault, u8,), 0) == 0);
const _: () = assert!(::core::mem::offset_of!((::tuples_golden::HasNoDefault, u8,), 1) == 24);
#[unsafe(no_mangle)]
...
const _: () = assert!(::core::mem::offset_of!((u8, ::tuples_golden::HasDefault,), 1) == 8);
const _: () = assert!(::core::mem::offset_of!((u8, ::tuples_golden::HasNoDefault,), 0) == 0);
const _: () = assert!(::core::mem::offset_of!((u8, ::tuples_golden::HasNoDefault,), 1) == 8);
#[unsafe(no_mangle)]
...
const _: () = assert!(::core::mem::offset_of!((u8, usize,), 1) == 8);
#[unsafe(no_mangle)]
...
const _: () = assert!(::core::mem::offset_of!((usize, u8,), 1) == 8);
#[unsafe(no_mangle)]
