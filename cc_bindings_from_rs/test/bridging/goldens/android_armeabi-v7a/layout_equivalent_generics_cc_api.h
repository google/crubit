...
// CRUBIT_ANNOTATE: must_bind=
crubit::test::MyStatusOr<int32_t> create_status_with_private_secret();

// CRUBIT_ANNOTATE: must_bind=
crubit::test::MyStatusOr<int32_t> create_status_with_secret();

// CRUBIT_ANNOTATE: must_bind=
crubit::test::MyStatusOr<int32_t> create_status_with_secret_alias();

// CRUBIT_ANNOTATE: must_bind=
bool is_ok_secret(crubit::test::MyStatusOr<int32_t> status);
...
inline ::std::int32_t accept_optional_by_value(
    crubit::test::MyOptional<::std::int32_t> opt) {
  static_assert(sizeof(crubit::test::MyOptional<::std::int32_t>) == 8 &&
                    alignof(crubit::test::MyOptional<::std::int32_t>) == 4,
...
inline bool accept_status(crubit::test::MyStatus status) {
  static_assert(sizeof(crubit::test::MyStatus) == 1 &&
                    alignof(crubit::test::MyStatus) == 1,
                "Verify that C++ layout-equivalent type has the same size and "
                "alignment as the Rust type");
...
inline crubit::test::MyPair<bool, bool> create_bool_bool_pair() {
  static_assert(sizeof(crubit::test::MyPair<bool, bool>) == 2 &&
                    alignof(crubit::test::MyPair<bool, bool>) == 1,
                "Verify that C++ layout-equivalent type has the same size and "
                "alignment as the Rust type");
...
inline crubit::test::MyIntBoolPair create_int_bool_pair() {
  static_assert(sizeof(crubit::test::MyIntBoolPair) == 8 &&
                    alignof(crubit::test::MyIntBoolPair) == 4,
                "Verify that C++ layout-equivalent type has the same size and "
                "alignment as the Rust type");
  union __return_value_crubit_return_union {
    constexpr __return_value_crubit_return_union() {}
...
extern "C" void __crubit_thunk_create_ustatus_uwith_uprivate_usecret(
    crubit::test::MyStatusOr<int32_t>* __ret_ptr);
}
inline crubit::test::MyStatusOr<int32_t> create_status_with_private_secret() {
  static_assert(sizeof(crubit::test::MyStatusOr<int32_t>) == 8 &&
                    alignof(crubit::test::MyStatusOr<int32_t>) == 4,
                "Verify that C++ layout-equivalent type has the same size and "
                "alignment as the Rust type");
  union __return_value_crubit_return_union {
    constexpr __return_value_crubit_return_union() {}
    ~__return_value_crubit_return_union() { ::std::destroy_at(&this->val); }
    crubit::test::MyStatusOr<int32_t> val;
  } __return_value_ret_val_holder;
  auto* __return_value_storage = &__return_value_ret_val_holder.val;
...
inline crubit::test::MyStatusOr<int32_t> create_status_with_secret() {
  static_assert(sizeof(crubit::test::MyStatusOr<int32_t>) == 8 &&
                    alignof(crubit::test::MyStatusOr<int32_t>) == 4,
                "Verify that C++ layout-equivalent type has the same size and "
                "alignment as the Rust type");
...
inline crubit::test::MyStatusOr<int32_t> create_status_with_secret_alias() {
  static_assert(sizeof(crubit::test::MyStatusOr<int32_t>) == 8 &&
                    alignof(crubit::test::MyStatusOr<int32_t>) == 4,
                "Verify that C++ layout-equivalent type has the same size and "
                "alignment as the Rust type");
...
namespace __crubit_internal {
extern "C" bool __crubit_thunk_is_uok_usecret(
    crubit::test::MyStatusOr<int32_t>*);
}
inline bool is_ok_secret(crubit::test::MyStatusOr<int32_t> status) {
  static_assert(sizeof(crubit::test::MyStatusOr<int32_t>) == 8 &&
                    alignof(crubit::test::MyStatusOr<int32_t>) == 4,
                "Verify that C++ layout-equivalent type has the same size and "
                "alignment as the Rust type");
...
inline crubit::test::MyStatusOr<::std::uint64_t> return_status_non_unit(
    crubit::test::MyStatusOr<::std::uint32_t> status) {
  static_assert(sizeof(crubit::test::MyStatusOr<::std::uint32_t>) == 8 &&
