...
static_assert(
    sizeof(::lifetimes::StructWithLifetime) == 8,
...
static_assert(
    sizeof(::lifetimes::StructWithLifetimeAndDropGlue) == 32,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
...
inline void ::lifetimes::StructWithLifetimeAndDropGlue::
  ...
  static_assert(24 == offsetof(__crubit_assert_type, field_with_lifetime));
}
namespace __crubit_internal {
extern "C" void
