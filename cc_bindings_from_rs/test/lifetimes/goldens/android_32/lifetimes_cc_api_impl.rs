...
#[unsafe(no_mangle)]
unsafe extern "C" fn __crubit_thunk_into_uref_u_x00000027a(
...
#[unsafe(no_mangle)]
unsafe extern "C" fn __crubit_thunk_value_u_x00000027a(
    __self: *mut ::lifetimes_golden::StructWithLifetime<'static>,
) -> i32 {
    unsafe {
        let __self = __self.read();
...
#[unsafe(no_mangle)]
unsafe extern "C" fn __crubit_thunk_borrow_ufrom_uself_u_x00000027a(
