...
static_assert(
    sizeof(::structs::aggregate_initialization::AnnotatedTwoDrops) == 48,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::structs::aggregate_initialization::AnnotatedTwoDrops) == 8,
    "Verify that ADT layout didn't change since this header got generated");
...
static_assert(
    sizeof(::structs::aggregate_initialization::SingleDropField) == 24,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::structs::aggregate_initialization::SingleDropField) == 8,
    "Verify that ADT layout didn't change since this header got generated");
...
static_assert(
    sizeof(::structs::aggregate_initialization::UnannotatedTwoDrops) == 48,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::structs::aggregate_initialization::UnannotatedTwoDrops) == 8,
    "Verify that ADT layout didn't change since this header got generated");
namespace __crubit_internal {
extern "C" void
...
static_assert(
    sizeof(::structs::nested_ptr_type_mutability_qualifiers::SomeStruct) == 16,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::structs::nested_ptr_type_mutability_qualifiers::SomeStruct) == 8,
    "Verify that ADT layout didn't change since this header got generated");
namespace __crubit_internal {
extern "C" void
...
inline void ::structs::nested_ptr_type_mutability_qualifiers::SomeStruct::
  ...
  static_assert(8 == offsetof(__crubit_assert_type, const_mut_ptr));
}
}  // namespace structs::nested_ptr_type_mutability_qualifiers
