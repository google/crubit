...
const _: () = assert!(
    ::std::mem::size_of::<::structs_golden::aggregate_initialization::AnnotatedTwoDrops>() == 48
);
const _: () = assert!(
    ::std::mem::align_of::<::structs_golden::aggregate_initialization::AnnotatedTwoDrops>() == 8
);
const _: () = assert!(
    ::core::mem::offset_of!(::structs_golden::aggregate_initialization::AnnotatedTwoDrops, 0) == 0
);
const _: () = assert!(
    ::core::mem::offset_of!(::structs_golden::aggregate_initialization::AnnotatedTwoDrops, 1) == 24
);
const _: () = assert!(
...
const _: () = assert!(
    ::std::mem::size_of::<::structs_golden::aggregate_initialization::SingleDropField>() == 24
);
const _: () = assert!(
    ::std::mem::align_of::<::structs_golden::aggregate_initialization::SingleDropField>() == 8
);
const _: () = assert!(
...
const _: () = assert!(
    ::std::mem::size_of::<::structs_golden::aggregate_initialization::UnannotatedTwoDrops>() == 48
);
const _: () = assert!(
    ::std::mem::align_of::<::structs_golden::aggregate_initialization::UnannotatedTwoDrops>() == 8
);
#[unsafe(no_mangle)]
