...
extern crate alloc;
extern crate core;
const _: () = assert!(::std::mem::size_of::<::tuple_structs_golden::CloneNoDefault>() == 4);
const _: () = assert!(::std::mem::align_of::<::tuple_structs_golden::CloneNoDefault>() == 4);
#[unsafe(no_mangle)]
...
const _: () = assert!(::std::mem::size_of::<::tuple_structs_golden::DontMoveMe>() == 4);
const _: () = assert!(::std::mem::align_of::<::tuple_structs_golden::DontMoveMe>() == 4);
#[unsafe(no_mangle)]
...
const _: () =
    assert!(::std::mem::size_of::<::tuple_structs_golden::TupleStructWithCloneNoDefault>() == 4);
const _: () =
    assert!(::std::mem::align_of::<::tuple_structs_golden::TupleStructWithCloneNoDefault>() == 4);
#[unsafe(no_mangle)]
unsafe extern "C" fn __crubit_thunk_create(value: i32, __ret_ptr: *mut core::ffi::c_void) -> () {
    unsafe {
        let __rs_return_value =
...
const _: () =
    assert!(::std::mem::size_of::<::tuple_structs_golden::TupleStructWithCppImmovableType>() == 8);
const _: () =
    assert!(::std::mem::align_of::<::tuple_structs_golden::TupleStructWithCppImmovableType>() == 4);
#[unsafe(no_mangle)]
...
const _: () = assert!(
    ::core::mem::offset_of!(::tuple_structs_golden::TupleStructWithCppImmovableType, 0) == 4
);
const _: () = assert!(
