...
extern crate core;
const _: () =
    assert!(::std::mem::size_of::<::structs_golden::abi_classification::StructFloat>() == 12);
const _: () =
    assert!(::std::mem::align_of::<::structs_golden::abi_classification::StructFloat>() == 4);
#[unsafe(no_mangle)]
...
const _: () = assert!(
    ::std::mem::size_of::<::structs_golden::aggregate_initialization::TupleAggregate>() == 12
);
const _: () = assert!(
    ::std::mem::align_of::<::structs_golden::aggregate_initialization::TupleAggregate>() == 4
);
const _: () = assert!(
