...
struct CRUBIT_INTERNAL_RUST_TYPE(
    ":: structs_golden :: abi_classification :: StructFloat") alignas(4)
...
struct CRUBIT_INTERNAL_RUST_TYPE(
    ":: structs_golden :: aggregate_initialization :: "
    "UnannotatedTwoDrops") alignas(4) [[clang::trivial_abi]]
...
struct CRUBIT_INTERNAL_RUST_TYPE(
    ...
    "SomeStruct") alignas(4) [[clang::trivial_abi]] SomeStruct final {
 public:
...
struct CRUBIT_INTERNAL_RUST_TYPE(
    ...
    "StructFloat") alignas(4) [[clang::trivial_abi]] StructFloat final {
 public:
...
static_assert(
    sizeof(::structs::abi_classification::StructFloat) == 12,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::structs::abi_classification::StructFloat) == 4,
    "Verify that ADT layout didn't change since this header got generated");
...
static_assert(
    sizeof(::structs::aggregate_initialization::TupleAggregate) == 12,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
...
static_assert(
    sizeof(::structs::struct_by_float_passing_with_no_thunk::StructFloat) == 12,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
