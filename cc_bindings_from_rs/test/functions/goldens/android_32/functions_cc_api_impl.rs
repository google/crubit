...
#[unsafe(no_mangle)]
unsafe extern "C" fn __crubit_thunk_create_ustruct_uwith_upinned_urefs(
    pinned_ref: ::core::pin::Pin<&'static i32>,
    pinned_mut_ref: ::core::pin::Pin<&'static mut i32>,
    __ret_ptr: *mut core::ffi::c_void,
) -> () {
    unsafe {
        let __rs_return_value =
            ::functions_golden::fn_param_ty_tests::create_struct_with_pinned_refs(
                pinned_ref,
                pinned_mut_ref,
            );
        ::core::ptr::write(__ret_ptr as *mut _, __rs_return_value);
...
#[unsafe(no_mangle)]
unsafe extern "C" fn __crubit_thunk_deref_upinned_uint(x: ::core::pin::Pin<&'static i32>) -> i32 {
    unsafe { ::functions_golden::fn_param_ty_tests::deref_pinned_int(x) }
}
#[unsafe(no_mangle)]
unsafe extern "C" fn __crubit_thunk_get_uidentical_upinned_uint_uref(
    x: ::core::pin::Pin<&'static i32>,
) -> ::core::pin::Pin<&'static i32> {
    unsafe { ::functions_golden::fn_param_ty_tests::get_identical_pinned_int_ref(x) }
}
#[unsafe(no_mangle)]
unsafe extern "C" fn __crubit_thunk_get_uidentical_upinned_umut_uint_uref(
    x: ::core::pin::Pin<&'static mut i32>,
) -> ::core::pin::Pin<&'static mut i32> {
    unsafe { ::functions_golden::fn_param_ty_tests::get_identical_pinned_mut_int_ref(x) }
}
#[unsafe(no_mangle)]
...
#[unsafe(no_mangle)]
unsafe extern "C" fn __crubit_thunk_set_upinned_umut_uref_uto_usum_uof_uints(
    sum: ::core::pin::Pin<&'static mut i32>,
    x: i32,
    y: i32,
) -> () {
    unsafe { ::functions_golden::fn_param_ty_tests::set_pinned_mut_ref_to_sum_of_ints(sum, x, y) }
}
#[unsafe(no_mangle)]
