...
#include "cc_bindings_from_rs/test/bazel/multiple_crate_versions/v0_1_test.h"

namespace consumer_v0_1 {

std::string GetV0_1String() {
  my_crate::v0_1::SomeStruct s;
  return absl::StrCat(s);
}

std::string GetV0_1FreeFunction() {
  return std::string(my_crate::v0_1::free_function());
}
...
std::string GetV0_1AssocFunction() {
  return std::string(my_crate::v0_1::SomeStruct::assoc_function());
}

std::string GetV0_1Clone() {
  my_crate::v0_1::SomeStruct s;
  my_crate::v0_1::SomeStruct s2 = s;
