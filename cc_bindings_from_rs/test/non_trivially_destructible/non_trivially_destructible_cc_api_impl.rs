...
unsafe extern "C" fn __crubit_thunk_clone_ufrom(
    ...
    unsafe {
        <::non_trivially_destructible_golden::NonTriviallyDestructable as::core::clone::Clone>::clone_from(__self,source)
    }
}
const _: () = assert!(
    ::core::mem::offset_of!(::non_trivially_destructible_golden::NonTriviallyDestructable, field)
        == 0
);
#[unsafe(no_mangle)]
