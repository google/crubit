...
#[unsafe(no_mangle)]
unsafe extern "C" fn __crubit_thunk_return_uresult_udrop_uno_udefault_utuple(
    success: bool,
    __ret_ptr: *mut core::ffi::c_void,
) -> () {
    unsafe {
        let __rs_return_value = ::result_golden::return_result_drop_no_default_tuple(success);
...
#[unsafe(no_mangle)]
unsafe extern "C" fn __crubit_thunk_take_uresult_udrop_uno_udefault_utuple(
    val: *const [*const core::ffi::c_void; 1usize],
) -> bool {
    unsafe {
        let val = ({
            let val_0: *mut ::core::result::Result<(), ::result_golden::DropNoDefault> = ((*val)
                [0usize]
                as *const *mut ::core::result::Result<(), ::result_golden::DropNoDefault>)
                .read();
            let val_0 = val_0.read();
            val_0
        },);
        ::result_golden::take_result_drop_no_default_tuple(val)
    }
}
#[unsafe(no_mangle)]
