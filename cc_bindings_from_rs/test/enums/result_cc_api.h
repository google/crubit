...
struct alignas(8)
 ...
 private:
  ...
  ::std::intptr_t* err_ptr() noexcept {
    return reinterpret_cast<::std::intptr_t*>(__storage + 8);
  }
  ::std::intptr_t const* err_const_ptr() const noexcept {
    return reinterpret_cast<::std::intptr_t const*>(__storage + 8);
  }
  void set_ok_tag() noexcept { set_tag(0); }
  void set_err_tag() noexcept { set_tag(1); }
  constexpr ::std::uint8_t tag() const& noexcept;
...
struct alignas(8)
 ...
 private:
  ...
  ::std::uintptr_t* err_ptr() noexcept {
    return reinterpret_cast<::std::uintptr_t*>(__storage + 8);
  }
  ::std::uintptr_t const* err_const_ptr() const noexcept {
    return reinterpret_cast<::std::uintptr_t const*>(__storage + 8);
  }
  void set_ok_tag() noexcept { set_tag(0); }
  void set_err_tag() noexcept { set_tag(1); }
  constexpr ::std::uint8_t tag() const& noexcept;
