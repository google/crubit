...
const _: () = assert!(::std::mem::size_of::<::option_golden::OverlappingOptions>() == 32);
...
const _: () =
    assert!(::core::mem::offset_of!(::option_golden::OverlappingOptions, sixty_four) == 0);
const _: () = assert!(::core::mem::offset_of!(::option_golden::OverlappingOptions, size) == 16);
const _: () =
    assert!(::core::mem::offset_of!(::option_golden::OverlappingOptions, thirty_two) == 24);
