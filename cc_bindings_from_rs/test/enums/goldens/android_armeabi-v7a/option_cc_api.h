...
inline void OverlappingOptions::__crubit_field_offset_assertions() {
  static_assert(0 == offsetof(OverlappingOptions, sixty_four));
  static_assert(16 == offsetof(OverlappingOptions, size));
  static_assert(24 == offsetof(OverlappingOptions, thirty_two));
}
static_assert(
    sizeof(ZStream) == 4,
    "Verify that ADT layout didn't change since this header got generated");
