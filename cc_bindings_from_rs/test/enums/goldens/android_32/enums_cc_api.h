...
static_assert(
    sizeof(StructuredQrError) == 12,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(StructuredQrError) == 4,
    "Verify that ADT layout didn't change since this header got generated");
...
inline void MyEnum::__crubit_field_offset_assertions() {
  ...
  static_assert(12 == offsetof(MyEnum::__crubit_E_struct, __field1));
  static_assert(0 == offsetof(MyEnum::__crubit_A_struct, __field0));
  static_assert(4 == offsetof(MyEnum::__crubit_A_struct, __field1));
...
inline void CloneCount::__crubit_field_offset_assertions() {
  static_assert(4 == offsetof(CloneCount, A));
...
inline void DropMe::__crubit_field_offset_assertions() {
  static_assert(4 == offsetof(DropMe, A));
  static_assert(4 == offsetof(DropMe, B));
  static_assert(4 == offsetof(DropMe, C));
