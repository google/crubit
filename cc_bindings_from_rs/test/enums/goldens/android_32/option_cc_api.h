...
// Zero-sized type `option_golden::OptUninhabited` is not supported
// (b/258259459)
...
struct CRUBIT_INTERNAL_RUST_TYPE(":: option_golden :: OptZst") alignas(1)
 ...
 private:
  ...
  //   Failed to format type for the definition of `option_golden::Unit`:
  //   Zero-sized type `option_golden::Unit` is not supported (b/258259459)
...
// Zero-sized type `option_golden::UninhabitedEnum` is not supported
// (b/258259459)
...
::std::int32_t take_option_bridged(rs_std::Option<int> x);
...
template <>
struct alignas(4) CRUBIT_INTERNAL_RUST_TYPE(
    "std :: option :: Option < isize >") rs_std::Option<::std::int32_t>
    : public rs_std::OptionBase<rs_std::Option<::std::int32_t>,
                                ::std::int32_t> {
 public:
  // Rust types that are `Copy` get trivial, `default` C++ copy constructor and
...
struct alignas(4) CRUBIT_INTERNAL_RUST_TYPE(
    ...
    rs_std::Option<int> : public rs_std::OptionBase<rs_std::Option<int>, int> {
 public:
  ...
  Option(::crubit::UnsafeRelocateTag, Option&& value);
  using base_type = rs_std::OptionBase<rs_std::Option<int>, int>;
  constexpr Option() = default;
  constexpr Option(::std::nullopt_t) noexcept;
  constexpr Option& operator=(::std::nullopt_t) noexcept;
  template <typename U>
    requires(rs_std::OptionForwardConstructible<Option, int, U>)
  Option(U&& value) noexcept;
  template <typename U>
    requires(rs_std::OptionForwardConstructible<Option, int, U>)
  Option& operator=(U&& value) noexcept;
  template <typename Opt>
    requires(rs_std::OptionFromStdOptional<int, Opt>)
  Option(Opt&& value) noexcept;
  template <typename Opt>
    requires(rs_std::OptionFromStdOptional<int, Opt>)
  Option& operator=(Opt&& value) noexcept;
 ...
 private:
  ...
  using tag_type = ::std::uint32_t;
  static constexpr tag_type kNoneVal = 0;
  int* some_ptr() noexcept { return reinterpret_cast<int*>(storage_ + 4); }
  int const* some_const_ptr() const noexcept {
    return reinterpret_cast<int const*>(storage_ + 4);
  }
  void set_some_tag() noexcept { set_tag(1); }
  constexpr void set_none_tag() noexcept { set_tag(kNoneVal); }
  constexpr bool is_none() const noexcept { return tag() == kNoneVal; }
...
template <>
struct alignas(4) CRUBIT_INTERNAL_RUST_TYPE(
    "std :: option :: Option < usize >") rs_std::Option<::std::uint32_t>
    : public rs_std::OptionBase<rs_std::Option<::std::uint32_t>,
                                ::std::uint32_t> {
 public:
  // Rust types that are `Copy` get trivial, `default` C++ copy constructor and
...
namespace __crubit_internal {
extern "C" ::std::int32_t __crubit_thunk_take_uoption_ubridged(
    rs_std::Option<int>*);
}
inline ::std::int32_t take_option_bridged(rs_std::Option<int> x) {
...
#ifndef _CRUBIT_BINDINGS_FOR_IMPL_rs_ustd_x00000020_x0000003a_x0000003a_x00000020Option_x00000020_x0000003c_x00000020int_x00000020_x0000003e
#define _CRUBIT_BINDINGS_FOR_IMPL_rs_ustd_x00000020_x0000003a_x0000003a_x00000020Option_x00000020_x0000003c_x00000020int_x00000020_x0000003e
static_assert(::std::is_trivially_move_constructible_v<rs_std::Option<int>>);
static_assert(::std::is_trivially_move_assignable_v<rs_std::Option<int>>);
inline rs_std::Option<int>::Option(::crubit::UnsafeRelocateTag,
                                   Option&& value) {
  ::std::memcpy(this, &value, sizeof(value));
}
static_assert(::std::is_trivially_destructible_v<rs_std::Option<int>>);
inline constexpr ::std::uint32_t rs_std::Option<int>::tag() const& noexcept {
  ::std::array<unsigned char, sizeof(::std::uint32_t)> __bytes = {};
  for (::std::size_t i = 0; i < sizeof(::std::uint32_t); ++i) {
    __bytes[i] = storage_[0 + i];
  }
...
inline constexpr void rs_std::Option<int>::set_tag(
    ::std::uint32_t tag) noexcept {
  auto __bytes =
      ::std::bit_cast<::std::array<unsigned char, sizeof(::std::uint32_t)>>(
          tag);
...
inline constexpr rs_std::Option<int>::Option(::std::nullopt_t) noexcept
    : base_type(::std::nullopt) {}
inline constexpr rs_std::Option<int>& rs_std::Option<int>::operator=(
    ::std::nullopt_t) noexcept {
  base_type::operator=(::std::nullopt);
  return *this;
}
template <typename U>
  requires(rs_std::OptionForwardConstructible<rs_std::Option<int>, int, U>)
inline rs_std::Option<int>::Option(U&& value) noexcept
    : base_type(::std::forward<U>(value)) {}
template <typename U>
  requires(rs_std::OptionForwardConstructible<rs_std::Option<int>, int, U>)
inline rs_std::Option<int>& rs_std::Option<int>::operator=(U&& value) noexcept {
  base_type::operator=(::std::forward<U>(value));
  return *this;
}
template <typename Opt>
  requires(rs_std::OptionFromStdOptional<int, Opt>)
inline rs_std::Option<int>::Option(Opt&& value) noexcept
    : base_type(::std::forward<Opt>(value)) {}
template <typename Opt>
  requires(rs_std::OptionFromStdOptional<int, Opt>)
inline rs_std::Option<int>& rs_std::Option<int>::operator=(
    Opt&& value) noexcept {
  base_type::operator=(::std::forward<Opt>(value));
  return *this;
}
template <typename... Args>
inline rs_std::Option<int>::Option(::std::in_place_t ip,
                                   Args&&... args) noexcept
    : base_type(ip, ::std::forward<Args>(args)...) {}
