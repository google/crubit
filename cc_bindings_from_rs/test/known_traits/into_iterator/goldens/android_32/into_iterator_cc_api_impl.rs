...
const _: () =
    assert!(::std::mem::size_of::<::into_iterator_rust_golden::ContainerWithRefIntoIter>() == 4);
const _: () =
    assert!(::std::mem::align_of::<::into_iterator_rust_golden::ContainerWithRefIntoIter>() == 4);
const _: () = assert!(
...
const _: () =
    assert!(::std::mem::size_of::<::into_iterator_rust_golden::MyContainerIntoIter>() == 16);
const _: () =
    assert!(::std::mem::align_of::<::into_iterator_rust_golden::MyContainerIntoIter>() == 4);
const _: () = assert!(::std::mem::size_of::<::into_iterator_rust_golden::MyContainerIter>() == 8);
const _: () = assert!(::std::mem::align_of::<::into_iterator_rust_golden::MyContainerIter>() == 4);
const _: () =
    assert!(::std::mem::size_of::<::into_iterator_rust_golden::MyContainerIterMut>() == 8);
const _: () =
    assert!(::std::mem::align_of::<::into_iterator_rust_golden::MyContainerIterMut>() == 4);
