...
static_assert(
    sizeof(::into_iterator_rust::ContainerWithRefIntoIter) == 8,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::into_iterator_rust::ContainerWithRefIntoIter) == 8,
    "Verify that ADT layout didn't change since this header got generated");
...
static_assert(
    sizeof(::into_iterator_rust::MyContainerIntoIter) == 24,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::into_iterator_rust::MyContainerIntoIter) == 8,
    "Verify that ADT layout didn't change since this header got generated");
...
inline void ::into_iterator_rust::MyContainerIntoIter::
  ...
  static_assert(0 == offsetof(__crubit_assert_type, index));
  static_assert(8 == offsetof(__crubit_assert_type, data));
}
static_assert(
    sizeof(::into_iterator_rust::MyContainerIter) == 16,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::into_iterator_rust::MyContainerIter) == 8,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
...
static_assert(
    sizeof(::into_iterator_rust::MyContainerIterMut) == 16,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::into_iterator_rust::MyContainerIterMut) == 8,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(::std::is_trivially_destructible_v<
