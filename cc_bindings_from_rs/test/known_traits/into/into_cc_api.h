...
static_assert(
    sizeof(::into::CloneAllocTarget) == 24,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::into::CloneAllocTarget) == 8,
    "Verify that ADT layout didn't change since this header got generated");
...
static_assert(
    sizeof(::into::CloneAllocType) == 24,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::into::CloneAllocType) == 8,
    "Verify that ADT layout didn't change since this header got generated");
...
static_assert(
    ...
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::into::CollidingOperators) == 8,
    "Verify that ADT layout didn't change since this header got generated");
...
static_assert(
    sizeof(::into::ConvertRef) == 16,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::into::ConvertRef) == 8,
    "Verify that ADT layout didn't change since this header got generated");
...
static_assert(
    sizeof(::into::NotFfiSafe) == 8,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::into::NotFfiSafe) == 8,
    "Verify that ADT layout didn't change since this header got generated");
