...
struct CRUBIT_INTERNAL_RUST_TYPE(
    ":: from_golden :: CollidingConstructor") alignas(4) [[clang::trivial_abi]]
...
static_assert(
    sizeof(::from::BoolAndStr) == 12,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::from::BoolAndStr) == 4,
    "Verify that ADT layout didn't change since this header got generated");
...
inline void ::from::BoolAndStr::__crubit_field_offset_assertions() {
  ...
  static_assert(4 == offsetof(__crubit_assert_type, int_val_));
  static_assert(8 == offsetof(__crubit_assert_type, is_bool_));
}
static_assert(
    sizeof(::from::CloneAllocSource) == 12,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::from::CloneAllocSource) == 4,
    "Verify that ADT layout didn't change since this header got generated");
...
static_assert(
    sizeof(::from::CloneAllocType) == 12,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::from::CloneAllocType) == 4,
    "Verify that ADT layout didn't change since this header got generated");
...
static_assert(
    ...
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::from::CollidingConstructor) == 4,
    "Verify that ADT layout didn't change since this header got generated");
...
static_assert(
    sizeof(::from::NotFfiSafe) == 4,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::from::NotFfiSafe) == 4,
    "Verify that ADT layout didn't change since this header got generated");
...
static_assert(
    sizeof(::from::OpaqueRef) == 8,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::from::OpaqueRef) == 4,
    "Verify that ADT layout didn't change since this header got generated");
