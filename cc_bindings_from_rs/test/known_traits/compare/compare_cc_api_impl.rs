...
#[unsafe(no_mangle)]
extern "C" fn __crubit_thunk_cmp(
    lhs: &::compare_golden::MyOrd,
    rhs: &::compare_golden::MyOrd,
) -> i8 {
    match <::compare_golden::MyOrd as ::core::cmp::Ord>::cmp(lhs, rhs) {
...
#[unsafe(no_mangle)]
extern "C" fn __crubit_thunk_partial_ucmp_ucompare_ugolden_x0000003a_x0000003aMyPartialOrd(
...
#[unsafe(no_mangle)]
extern "C" fn __crubit_thunk_partial_ucmp_ucompare_ugolden_x0000003a_x0000003aMyUnordered(
