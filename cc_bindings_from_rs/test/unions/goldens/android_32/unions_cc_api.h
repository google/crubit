...
union CRUBIT_INTERNAL_RUST_TYPE(
    ":: unions_golden :: repr_rust_drop :: U") alignas(4) [[clang::trivial_abi]]
U final {
 public:
  // Default::default
  U();
...
static_assert(
    sizeof(::unions::repr_c_drop::U) == 4,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::unions::repr_c_drop::U) == 4,
    "Verify that ADT layout didn't change since this header got generated");
namespace __crubit_internal {
extern "C" void
...
static_assert(
    sizeof(::unions::repr_rust_drop::U) == 4,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::unions::repr_rust_drop::U) == 4,
    "Verify that ADT layout didn't change since this header got generated");
namespace __crubit_internal {
extern "C" void
