...
static_assert(
    sizeof(::traits::AssociatedTypeStruct) == 32,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::traits::AssociatedTypeStruct) == 8,
    "Verify that ADT layout didn't change since this header got generated");
...
inline void ::traits::AssociatedTypeStruct::__crubit_field_offset_assertions() {
  ...
  static_assert(24 == offsetof(__crubit_assert_type, b));
}
static_assert(
    sizeof(::traits::Foo) == 8,
    "Verify that ADT layout didn't change since this header got generated");
...
static_assert(
    sizeof(::traits::LifetimeStruct) == 8,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::traits::LifetimeStruct) == 8,
    "Verify that ADT layout didn't change since this header got generated");
