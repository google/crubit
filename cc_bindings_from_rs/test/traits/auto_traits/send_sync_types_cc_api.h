...
static_assert(
    sizeof(::send_sync_types::NeitherSendNorSync) == 4,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::send_sync_types::NeitherSendNorSync) == 4,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    ::std::is_trivially_destructible_v<::send_sync_types::NeitherSendNorSync>);
...
inline void ::send_sync_types::NeitherSendNorSync::
    __crubit_field_offset_assertions() {
  using __crubit_assert_type = ::send_sync_types::NeitherSendNorSync;
  static_assert(0 == offsetof(__crubit_assert_type, __field0));
}
static_assert(
    sizeof(::send_sync_types::SendAndSync) == 4,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
...
inline void ::send_sync_types::SendAndSync::__crubit_field_offset_assertions() {
  using __crubit_assert_type = ::send_sync_types::SendAndSync;
  static_assert(0 == offsetof(__crubit_assert_type, __field0));
}
static_assert(
    sizeof(::send_sync_types::SendButNotSync) == 4,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::send_sync_types::SendButNotSync) == 4,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    ::std::is_trivially_destructible_v<::send_sync_types::SendButNotSync>);
static_assert(::std::is_trivially_move_constructible_v<
...
inline void ::send_sync_types::SendButNotSync::
    __crubit_field_offset_assertions() {
  using __crubit_assert_type = ::send_sync_types::SendButNotSync;
  static_assert(0 == offsetof(__crubit_assert_type, __field0));
}
static_assert(
    sizeof(::send_sync_types::SyncButNotSend) == 4,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    alignof(::send_sync_types::SyncButNotSend) == 4,
    "Verify that ADT layout didn't change since this header got generated");
static_assert(
    ::std::is_trivially_destructible_v<::send_sync_types::SyncButNotSend>);
static_assert(::std::is_trivially_move_constructible_v<
...
inline void ::send_sync_types::SyncButNotSend::
    __crubit_field_offset_assertions() {
  using __crubit_assert_type = ::send_sync_types::SyncButNotSend;
  static_assert(0 == offsetof(__crubit_assert_type, __field0));
}
}  // namespace send_sync_types
