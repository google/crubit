...
const _: () = assert!(
    ::core::mem::offset_of!(::primitive_types_golden::field_types::Types, c_ulonglong) == 8
);
const _: () =
    assert!(::core::mem::offset_of!(::primitive_types_golden::field_types::Types, c_double) == 16);
const _: () =
    assert!(::core::mem::offset_of!(::primitive_types_golden::field_types::Types, i64) == 24);
const _: () =
    assert!(::core::mem::offset_of!(::primitive_types_golden::field_types::Types, u64) == 32);
const _: () =
    assert!(::core::mem::offset_of!(::primitive_types_golden::field_types::Types, f64) == 40);
const _: () = assert!(
    ::core::mem::offset_of!(::primitive_types_golden::field_types::Types, c_void_mut_ptr) == 48
);
const _: () = assert!(
    ::core::mem::offset_of!(::primitive_types_golden::field_types::Types, c_void_const_ptr) == 52
);
const _: () =
    assert!(::core::mem::offset_of!(::primitive_types_golden::field_types::Types, c_int) == 56);
const _: () =
    assert!(::core::mem::offset_of!(::primitive_types_golden::field_types::Types, c_uint) == 60);
const _: () =
    assert!(::core::mem::offset_of!(::primitive_types_golden::field_types::Types, c_long) == 64);
const _: () =
    assert!(::core::mem::offset_of!(::primitive_types_golden::field_types::Types, c_ulong) == 68);
const _: () =
    assert!(::core::mem::offset_of!(::primitive_types_golden::field_types::Types, c_float) == 72);
const _: () =
    assert!(::core::mem::offset_of!(::primitive_types_golden::field_types::Types, i32) == 76);
const _: () =
    assert!(::core::mem::offset_of!(::primitive_types_golden::field_types::Types, u32) == 80);
const _: () =
...
const _: () =
    assert!(::core::mem::offset_of!(::primitive_types_golden::field_types::Types, i8_func) == 96);
const _: () = assert!(
    ::core::mem::offset_of!(::primitive_types_golden::field_types::Types, c_char_func) == 100
);
const _: () =
