...
static_assert(
    sizeof(::primitive_types::field_types::Types) == 152,
...
inline void ::primitive_types::field_types::Types::
  ...
  static_assert(0 == offsetof(__crubit_assert_type, i8_func));
  static_assert(8 == offsetof(__crubit_assert_type, c_char_func));
  static_assert(16 == offsetof(__crubit_assert_type, c_void_mut_ptr));
  static_assert(24 == offsetof(__crubit_assert_type, c_void_const_ptr));
  static_assert(32 == offsetof(__crubit_assert_type, c_long));
  static_assert(40 == offsetof(__crubit_assert_type, c_ulong));
  static_assert(48 == offsetof(__crubit_assert_type, c_longlong));
  static_assert(56 == offsetof(__crubit_assert_type, c_ulonglong));
  static_assert(64 == offsetof(__crubit_assert_type, c_double));
  static_assert(72 == offsetof(__crubit_assert_type, i64));
  static_assert(80 == offsetof(__crubit_assert_type, u64));
  static_assert(88 == offsetof(__crubit_assert_type, isize));
  static_assert(96 == offsetof(__crubit_assert_type, usize));
  static_assert(104 == offsetof(__crubit_assert_type, f64));
  static_assert(112 == offsetof(__crubit_assert_type, c_int));
  static_assert(116 == offsetof(__crubit_assert_type, c_uint));
  static_assert(120 == offsetof(__crubit_assert_type, c_float));
  static_assert(124 == offsetof(__crubit_assert_type, i32));
  static_assert(128 == offsetof(__crubit_assert_type, u32));
  static_assert(132 == offsetof(__crubit_assert_type, f32));
  static_assert(136 == offsetof(__crubit_assert_type, c_short));
  static_assert(138 == offsetof(__crubit_assert_type, c_ushort));
  static_assert(140 == offsetof(__crubit_assert_type, i16));
  static_assert(142 == offsetof(__crubit_assert_type, u16));
  static_assert(144 == offsetof(__crubit_assert_type, c_char));
  static_assert(145 == offsetof(__crubit_assert_type, c_schar));
  static_assert(146 == offsetof(__crubit_assert_type, c_uchar));
  static_assert(147 == offsetof(__crubit_assert_type, i8));
  static_assert(148 == offsetof(__crubit_assert_type, u8));
}
}  // namespace primitive_types::field_types
...
inline void ::primitive_types::test_c_void_ptr::StructWithCVoidPointerMember::
  ...
  static_assert(8 == offsetof(__crubit_assert_type, ptr_mut));
}
namespace __crubit_internal {
