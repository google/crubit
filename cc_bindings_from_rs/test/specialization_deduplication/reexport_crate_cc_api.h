...
// clang-format off
#ifndef THIRD_PARTY_CRUBIT_CC_BINDINGS_FROM_RS_TEST_SPECIALIZATION_DEDUPLICATION_REEXPORT_CRATE_GOLDEN
#define THIRD_PARTY_CRUBIT_CC_BINDINGS_FROM_RS_TEST_SPECIALIZATION_DEDUPLICATION_REEXPORT_CRATE_GOLDEN
...
#include "cc_bindings_from_rs/test/specialization_deduplication/dep_crate.h"

namespace reexport_crate {

rs_std::Result<::dep_crate::ExpectedName, ::std::int32_t> use_s();

rs_std::Result<::dep_crate::ExpectedName, ::std::int32_t> use_s_alias();

}  // namespace reexport_crate

#ifndef _CRUBIT_BINDINGS_FOR_rs_ustd_x00000020_x0000003a_x0000003a_x00000020Result_x00000020_x0000003c_x00000020_x0000003a_x0000003a_x00000020dep_ucrate_x00000020_x0000003a_x0000003a_x00000020ExpectedName_x00000020_x0000002c_x00000020int_x00000020_x0000003e
#define _CRUBIT_BINDINGS_FOR_rs_ustd_x00000020_x0000003a_x0000003a_x00000020Result_x00000020_x0000003c_x00000020_x0000003a_x0000003a_x00000020dep_ucrate_x00000020_x0000003a_x0000003a_x00000020ExpectedName_x00000020_x0000002c_x00000020int_x00000020_x0000003e
template <>
struct alignas(4) CRUBIT_INTERNAL_RUST_TYPE(
    "std :: result :: Result < :: dep_crate :: ExpectedName , i32 >")
...
using SAlias CRUBIT_INTERNAL_RUST_TYPE(":: dep_crate :: ExpectedName") =
    ::dep_crate::ExpectedName;
using Foo CRUBIT_INTERNAL_RUST_TYPE(":: dep_crate :: ExpectedName") =
    ::dep_crate::ExpectedName;
}  // namespace reexport_crate
...
namespace __crubit_internal {
extern "C" void __crubit_thunk_use_us_ualias(
    rs_std::Result<::dep_crate::ExpectedName, ::std::int32_t>* __ret_ptr);
}
inline rs_std::Result<::dep_crate::ExpectedName, ::std::int32_t> use_s_alias() {
  crubit::Slot<rs_std::Result<::dep_crate::ExpectedName, ::std::int32_t>>
      __return_value_ret_val_holder;
  auto* __return_value_storage = __return_value_ret_val_holder.Get();
  __crubit_internal::__crubit_thunk_use_us_ualias(__return_value_storage);
  return ::std::move(__return_value_ret_val_holder).AssumeInitAndTakeValue();
}

}  // namespace reexport_crate

#ifndef _CRUBIT_BINDINGS_FOR_IMPL_rs_ustd_x00000020_x0000003a_x0000003a_x00000020Result_x00000020_x0000003c_x00000020_x0000003a_x0000003a_x00000020dep_ucrate_x00000020_x0000003a_x0000003a_x00000020ExpectedName_x00000020_x0000002c_x00000020int_x00000020_x0000003e
#define _CRUBIT_BINDINGS_FOR_IMPL_rs_ustd_x00000020_x0000003a_x0000003a_x00000020Result_x00000020_x0000003c_x00000020_x0000003a_x0000003a_x00000020dep_ucrate_x00000020_x0000003a_x0000003a_x00000020ExpectedName_x00000020_x0000002c_x00000020int_x00000020_x0000003e
...
#endif  // THIRD_PARTY_CRUBIT_CC_BINDINGS_FROM_RS_TEST_SPECIALIZATION_DEDUPLICATION_REEXPORT_CRATE_GOLDEN
