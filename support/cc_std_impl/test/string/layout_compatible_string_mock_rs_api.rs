...
pub mod test {
    #[inline(always)]
    pub fn RoundTrip(
        s: ::ctor::Ctor![::cc_std::std::new_string],
    ) -> ::ctor::Ctor![::cc_std::std::new_string] {
        unsafe {
            ::ctor::FnCtor::new(move |__crubit_dest: *mut ::cc_std::std::new_string| {
                crate::detail::__rust_thunk___ZN4test9RoundTripENSt3__u12basic_stringIcNS0_11char_traitsIcEENS0_9allocatorIcEEEE(__crubit_dest as*mut::core::ffi::c_void,::core::pin::Pin::into_inner_unchecked(::ctor::emplace!(s)));
            })
        }
    }
...
const _: () = {
    ...
    static_assertions::assert_not_impl_any!(crate::test::StringStruct: Copy,Drop);
