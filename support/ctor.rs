...
/// An auto trait for types which can construct themselves.
///
/// This is true for almost every type, except for dedicated constructor types (like `FnCtor`),
/// which implement the `Ctor` trait for some other type.
///
