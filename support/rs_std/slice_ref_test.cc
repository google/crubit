...
static_assert(
    ::std::is_nothrow_constructible_v<rs_std::SliceRef<const uint8_t>>);
static_assert(
...
static_assert(::std::is_constructible_v<rs_std::SliceRef<const int>,
                                        const ::std::vector<int>&>);
static_assert(
    !::std::is_constructible_v<rs_std::SliceRef<int>, ::std::list<int>&>);
static_assert(!::std::is_constructible_v<rs_std::SliceRef<const int>,
                                         const ::std::list<int>&>);
...
TEST(ImplicitConversionTest, MutableFromVector) {
  ...
  // containers.
  static_assert(
      !::std::convertible_to<::std::vector<int>&, rs_std::SliceRef<int>>);
