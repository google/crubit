...
// IWYU pragma: private, include "support/rs_std/str_ref.h"
...
// `rs::StrRef` is a C++ representation of a pointer or reference to a
...
class CRUBIT_INTERNAL_RUST_TYPE("&str") CRUBIT_TRIVIAL_ABI StrRef final {
 public:
  ...
  constexpr
  operator ::std::string_view()  // NOLINT(google-explicit-constructor)
...
namespace rs_std {
using StrRef [[deprecated("Use rs::StrRef instead")]] CRUBIT_INTERNAL_RUST_TYPE(
    "&str") = rs::StrRef;
}  // namespace rs_std
...
template <>
struct PtrLike<rs::StrRef> {
  static constexpr bool kIsConst = true;
  static PtrData AsPtrData(rs::StrRef t) {
