...
#if defined(CRUBIT_SUPPORT_INTERNAL_RETURN_VALUE_SLOT_H_) && \
    !defined(CRUBIT_SLOT_USES_UNSAFE_RELOCATE_TAG_HEADER)
// UnsafeRelocateTag already defined by crosstool's slot.h.
#else
