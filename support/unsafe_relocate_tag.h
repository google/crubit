...
//
// Temporary migration guard: prevents duplicate definitions between this header
// and stable Crosstool until Crosstool rolls to the next Crubit release.
#ifndef CRUBIT_DEFINED_UNSAFE_RELOCATE_TAG
#define CRUBIT_DEFINED_UNSAFE_RELOCATE_TAG
