...
def _rust_bindings_from_cc_transition_impl(_settings, _attr):
    return {
        ...
        "@rules_crubit//rs_bindings_from_cc/bazel_support:use_actual_bindings_generator": False,
        "@rules_crubit//rs_bindings_from_cc/bazel_support:use_actual_deps": False,
    }
...
rust_bindings_from_cc_transition = transition(
    ...
    outputs = [
        ...
        "@rules_crubit//rs_bindings_from_cc/bazel_support:use_actual_bindings_generator",
        "@rules_crubit//rs_bindings_from_cc/bazel_support:use_actual_deps",
    ],
)
