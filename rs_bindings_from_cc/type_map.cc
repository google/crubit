...
namespace {
// Returns true if the type is a known primitive type.
bool IsPrimitive(absl::string_view cpp_type) {
  static const auto* const kWellKnownTypes =
      new absl::flat_hash_set<absl::string_view>({
          ...
          // `IsPrimitive`, but note that desugaring of type aliases
