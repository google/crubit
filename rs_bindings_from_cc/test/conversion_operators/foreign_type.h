...
struct ForeignImmovable {
  ...
  ForeignImmovable(const ForeignImmovable&) = delete;
  ForeignImmovable(ForeignImmovable&&) = delete;
};

#endif  // THIRD_PARTY_CRUBIT_RS_BINDINGS_FROM_CC_TEST_CONVERSION_OPERATORS_FOREIGN_TYPE_H_
