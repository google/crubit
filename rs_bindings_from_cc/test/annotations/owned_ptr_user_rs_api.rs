...
#[inline(always)]
pub fn MakeThing(value: ::core::ffi::c_int) -> *mut owned_ptr::Thing {
...
#[inline(always)]
pub unsafe fn GetThingValue(thingptr: *mut owned_ptr::Thing) -> ::core::ffi::c_int {
