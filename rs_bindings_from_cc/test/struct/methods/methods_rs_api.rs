...
impl InstanceMethods {
    ...
    #[inline(always)]
    pub fn get_int_field<'__this>(&'__this self) -> ::ffi_11::c_int {
    ...
    #[inline(always)]
    pub fn set_int_field<'__this>(&'__this mut self, new_value: ::ffi_11::c_int) {
        unsafe {
    ...
    #[inline(always)]
    pub fn inline_get_int_field<'__this>(&'__this self) -> ::ffi_11::c_int {
    ...
    #[inline(always)]
    pub fn inline_set_int_field<'__this>(&'__this mut self, new_value: ::ffi_11::c_int) {
        unsafe {
    ...
    #[inline(always)]
    pub fn takes_and_returns_ref<'__this, 'input_ref>(
        &'__this mut self,
        input_ref: &'input_ref mut ::ffi_11::c_int,
    ) -> &'__this mut ::ffi_11::c_int {
        unsafe {
    ...
    #[inline(always)]
    pub fn ref_qualified<'__this>(&'__this mut self) {
    ...
    #[inline(always)]
    pub fn const_ref_qualified<'__this>(&'__this self) {
    ...
    #[inline(always)]
    pub fn rvalue_qualified<'__this>(&'__this mut self) {
...
mod detail {
    ...
    unsafe extern "C" {
        ...
        pub(crate) unsafe fn __rust_thunk___ZNK15InstanceMethods13get_int_fieldEv<'__this>(
            __this: &'__this crate::InstanceMethods,
        ) -> ::ffi_11::c_int;
        #[link_name = "_ZN15InstanceMethods13set_int_fieldEi"]
        pub(crate) unsafe fn __rust_thunk___ZN15InstanceMethods13set_int_fieldEi<'__this>(
            __this: &'__this mut crate::InstanceMethods,
            new_value: ::ffi_11::c_int,
        );
        pub(crate) unsafe fn __rust_thunk___ZNK15InstanceMethods20inline_get_int_fieldEv<'__this>(
            __this: &'__this crate::InstanceMethods,
        ) -> ::ffi_11::c_int;
        pub(crate) unsafe fn __rust_thunk___ZN15InstanceMethods20inline_set_int_fieldEi<'__this>(
            __this: &'__this mut crate::InstanceMethods,
            new_value: ::ffi_11::c_int,
        );
        ...
        pub(crate) unsafe fn __rust_thunk___ZNR15InstanceMethods13ref_qualifiedEv<'__this>(
            __this: &'__this mut crate::InstanceMethods,
        );
        pub(crate) unsafe fn __rust_thunk___ZNKR15InstanceMethods19const_ref_qualifiedEv<'__this>(
            __this: &'__this crate::InstanceMethods,
        );
        pub(crate) unsafe fn __rust_thunk___ZNO15InstanceMethods16rvalue_qualifiedEv<'__this>(
            __this: &'__this mut crate::InstanceMethods,
        );
    }
}
