...
// Generated from: nowhere/llvm/src/libcxx/include/__type_traits/type_list.h;l=22
...
// //rs_bindings_from_cc/test/struct/default_member_functions:default_member_functions needs [//features:wrapper] for std::__type_list<std::__align_type<unsigned char>, std::__align_type<unsigned short>, std::__align_type<unsigned int>, std::__align_type<unsigned long>, std::__align_type<unsigned long long>, std::__align_type<double>, std::__align_type<long double>, std::__align_type<std::__struct_double>, std::__align_type<std::__struct_double4>, std::__align_type<int *>> (crate::__CcTemplateInstNSt3__u11__type_listIJNS_12__align_typeIhEENS1_ItEENS1_IjEENS1_ImEENS1_IyEENS1_IdEENS1_IeEENS1_INS_15__struct_doubleEEENS1_INS_16__struct_double4EEENS1_IPiEEEEE is a template instantiation)
