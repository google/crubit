...
use destructors::{DestructionOrderRecorder, FieldDestructionOrderTester};
...
fn test_field_destruction_order() {
    ...
    expect_eq!(expected_destruction_order_in_cpp, DestructionOrderRecorder::GetDestructionRecord());
