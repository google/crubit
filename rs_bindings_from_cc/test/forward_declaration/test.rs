...
mod tests {
    ...
    #[test]
    fn test_same_library_with_2_forward_declarations() {
        assert!(type_exists!(definition_and_forward_declarations_same_cc_library::A));
        assert!(type_exists!(definition_and_forward_declaration_same_cc_library::my_namespace::B));
    }
    ...
    // declaration and definition are from different targets.
    #[test]
    fn test_separate_library_with_2_forward_declarations() {
        assert!(!type_exists!(definition_and_forward_declarations_separate_cc_library::A));
        assert!(!type_exists!(
            definition_and_forward_declaration_separate_cc_library::my_namespace::B
        ));
    }
