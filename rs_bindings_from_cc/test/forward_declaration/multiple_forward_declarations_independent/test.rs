...
fn test_complete_to_incomplete_ptr_conversion_crossing_crate_boundaries() {
    ...
    unsafe {
        let identity1 = forward_declaration1::IdentityPtr1(a_ptr.cpp_cast());
        let identity2 = forward_declaration2::IdentityPtr2(a_ptr.cpp_cast());

        let identity2_from_identity1 = forward_declaration2::IdentityPtr2(identity1.cpp_cast());
        let identity1_from_identity2 = forward_declaration1::IdentityPtr1(identity2.cpp_cast());

        let _ = forward_declaration1::IdentityPtr1(identity2_from_identity1.cpp_cast());
        let _ = forward_declaration2::IdentityPtr2(identity1_from_identity2.cpp_cast());
    }
}
