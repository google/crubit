...
static_assert(CRUBIT_OFFSET_OF(value, struct crubit::test::ItemNonUnpin) == 0);
...
static_assert(CRUBIT_SIZEOF(class crubit::test::ContainerUnpinItemUnpin) == 40);
...
static_assert(
    CRUBIT_OFFSET_OF(items_, class crubit::test::ContainerUnpinItemNonUnpin) ==
    40);
...
static_assert(alignof(class crubit::test::ContainerNonUnpinItemNonUnpin) == 4);
...
static_assert(CRUBIT_OFFSET_OF(value,
                               struct crubit::test::ContainerMutRefFromConst) ==
              0);
...
static_assert(CRUBIT_OFFSET_OF(value,
                               struct crubit::test::ContainerConstRefFromMut) ==
              0);
