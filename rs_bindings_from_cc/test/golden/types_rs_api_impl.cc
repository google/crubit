...
static_assert(CRUBIT_OFFSET_OF(signed_char_field,
                               struct ::FieldTypeTestStruct) == 3);
...
static_assert(CRUBIT_OFFSET_OF(signed_int_field,
                               struct ::FieldTypeTestStruct) == 68);
static_assert(CRUBIT_OFFSET_OF(signed_long_field,
                               struct ::FieldTypeTestStruct) == 72);
...
static_assert(CRUBIT_OFFSET_OF(size_t_field, struct ::FieldTypeTestStruct) ==
              96);
static_assert(CRUBIT_OFFSET_OF(float_field, struct ::FieldTypeTestStruct) ==
              104);
...
static_assert(CRUBIT_OFFSET_OF(struct_field, struct ::FieldTypeTestStruct) ==
              152);
static_assert(CRUBIT_OFFSET_OF(struct_ptr_field,
                               struct ::FieldTypeTestStruct) == 160);
static_assert(CRUBIT_OFFSET_OF(const_struct_ptr_field,
                               struct ::FieldTypeTestStruct) == 168);
static_assert(CRUBIT_OFFSET_OF(struct_ref_field,
                               struct ::FieldTypeTestStruct) == 176);
...
static_assert(CRUBIT_OFFSET_OF(cyclic_ptr_field,
