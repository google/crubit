...
pub mod test_namespace_bindings {
    ...
    // Can't generate bindings for Alias7, because of missing required features (<internal link>):
    // //rs_bindings_from_cc/test/golden:templates_source_order_cc needs [//features:wrapper] for Alias7 (error: Can't generate bindings for MyTemplate<char>, because of missing required features (<internal link>):
    ...
    // Can't generate bindings for Alias8, because of missing required features (<internal link>):
    // //rs_bindings_from_cc/test/golden:templates_source_order_cc needs [//features:wrapper] for Alias8 (error: Can't generate bindings for MyTemplate<test_namespace_bindings::Inner>, because of missing required features (<internal link>):
