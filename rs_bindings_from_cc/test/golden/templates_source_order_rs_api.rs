...
// Can't generate bindings for Alias1, because of missing required features (<internal link>):
// //rs_bindings_from_cc/test/golden:templates_source_order_cc needs [//features:wrapper] for Alias1 (error: Can't generate bindings for MyTemplate<int>, because of missing required features (<internal link>):
...
// Can't generate bindings for Alias2, because of missing required features (<internal link>):
// //rs_bindings_from_cc/test/golden:templates_source_order_cc needs [//features:wrapper] for Alias2 (error: Can't generate bindings for MyTemplate<float>, because of missing required features (<internal link>):
...
// Can't generate bindings for Alias3, because of missing required features (<internal link>):
// //rs_bindings_from_cc/test/golden:templates_source_order_cc needs [//features:wrapper] for Alias3 (error: Can't generate bindings for MyTemplate<TopLevel>, because of missing required features (<internal link>):
...
// Can't generate bindings for Alias4, because of missing required features (<internal link>):
// //rs_bindings_from_cc/test/golden:templates_source_order_cc needs [//features:wrapper] for Alias4 (error: Can't generate bindings for MyTemplate<double>, because of missing required features (<internal link>):
...
// Can't generate bindings for Alias5, because of missing required features (<internal link>):
// //rs_bindings_from_cc/test/golden:templates_source_order_cc needs [//features:wrapper] for Alias5 (error: Can't generate bindings for MyTemplate<bool>, because of missing required features (<internal link>):
...
pub mod test_namespace_bindings {
    ...
    // Can't generate bindings for test_namespace_bindings::Alias7, because of missing required features (<internal link>):
    // //rs_bindings_from_cc/test/golden:templates_source_order_cc needs [//features:wrapper] for test_namespace_bindings::Alias7 (error: Can't generate bindings for MyTemplate<char>, because of missing required features (<internal link>):
    ...
    // Can't generate bindings for test_namespace_bindings::Alias8, because of missing required features (<internal link>):
    // //rs_bindings_from_cc/test/golden:templates_source_order_cc needs [//features:wrapper] for test_namespace_bindings::Alias8 (error: Can't generate bindings for MyTemplate<test_namespace_bindings::Inner>, because of missing required features (<internal link>):
    ...
    // Can't generate bindings for test_namespace_bindings::Alias9, because of missing required features (<internal link>):
    // //rs_bindings_from_cc/test/golden:templates_source_order_cc needs [//features:wrapper] for test_namespace_bindings::Alias9 (error: Can't generate bindings for MyTemplate<MyTemplate<test_namespace_bindings::Inner>>, because of missing required features (<internal link>):
...
// Can't generate bindings for MyTemplate<TopLevel>, because of missing required features (<internal link>):
// //rs_bindings_from_cc/test/golden:templates_source_order_cc needs [//features:wrapper] for MyTemplate<TopLevel> (crate::__CcTemplateInst10MyTemplateI8TopLevelE is a template instantiation)
// //rs_bindings_from_cc/test/golden:templates_source_order_cc needs [//features:wrapper] for MyTemplate<TopLevel> (crate::__CcTemplateInst10MyTemplateI8TopLevelE is a template instantiation)

// Error while generating bindings for class 'MyTemplate<test_namespace_bindings::Inner>':
// Can't generate bindings for MyTemplate<test_namespace_bindings::Inner>, because of missing required features (<internal link>):
// //rs_bindings_from_cc/test/golden:templates_source_order_cc needs [//features:wrapper] for MyTemplate<test_namespace_bindings::Inner> (crate::__CcTemplateInst10MyTemplateIN23test_namespace_bindings5InnerEE is a template instantiation)
// //rs_bindings_from_cc/test/golden:templates_source_order_cc needs [//features:wrapper] for MyTemplate<test_namespace_bindings::Inner> (crate::__CcTemplateInst10MyTemplateIN23test_namespace_bindings5InnerEE is a template instantiation)
...
// Can't generate bindings for MyTemplate<char>, because of missing required features (<internal link>):
// //rs_bindings_from_cc/test/golden:templates_source_order_cc needs [//features:wrapper] for MyTemplate<char> (crate::__CcTemplateInst10MyTemplateIcE is a template instantiation)
// //rs_bindings_from_cc/test/golden:templates_source_order_cc needs [//features:wrapper] for MyTemplate<char> (crate::__CcTemplateInst10MyTemplateIcE is a template instantiation)

// Error while generating bindings for class 'MyTemplate<double>':
// Can't generate bindings for MyTemplate<double>, because of missing required features (<internal link>):
// //rs_bindings_from_cc/test/golden:templates_source_order_cc needs [//features:wrapper] for MyTemplate<double> (crate::__CcTemplateInst10MyTemplateIdE is a template instantiation)
// //rs_bindings_from_cc/test/golden:templates_source_order_cc needs [//features:wrapper] for MyTemplate<double> (crate::__CcTemplateInst10MyTemplateIdE is a template instantiation)
