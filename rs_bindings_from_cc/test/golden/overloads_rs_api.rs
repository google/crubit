...
// Can't generate bindings for Foo::Bar, because of missing required features (<internal link>):
// //rs_bindings_from_cc/test/golden:overloads_cc needs [//features:wrapper] for Foo::Bar (the type of __param_0 (parameter #1): error: Can't generate bindings for Sizeof<int>, because of missing required features (<internal link>):
...
// Error while generating bindings for function 'Foo::Bar':
// Can't generate bindings for Foo::Bar, because of missing required features (<internal link>):
// //rs_bindings_from_cc/test/golden:overloads_cc needs [//features:wrapper] for Foo::Bar (the type of __param_0 (parameter #1): error: Can't generate bindings for Sizeof<float>, because of missing required features (<internal link>):
