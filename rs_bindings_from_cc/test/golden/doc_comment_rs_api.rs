...
// //rs_bindings_from_cc/test/golden:doc_comment_cc needs [//features:wrapper] for ConcreteNestedStruct (error: Can't generate bindings for OuterTemplate<int>::NestedStruct, because of missing required features (<internal link>):
