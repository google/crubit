...
static_assert(sizeof(struct ::no_longer_top_level::already_snake_case::Inner) ==
              1);
static_assert(
    alignof(struct ::no_longer_top_level::already_snake_case::Inner) == 1);
...
static_assert(sizeof(struct ::no_longer_top_level::ConflictingSnakeCaseNames) ==
              1);
static_assert(
    alignof(struct ::no_longer_top_level::ConflictingSnakeCaseNames) == 1);
...
static_assert(
    sizeof(struct ::no_longer_top_level::ConflictingSnakeCaseNames::Inner) ==
    1);
static_assert(
    alignof(struct ::no_longer_top_level::ConflictingSnakeCaseNames::Inner) ==
    1);
...
static_assert(
    sizeof(struct ::no_longer_top_level::ConflictingSnakeCaseNames_) == 1);
static_assert(
    alignof(struct ::no_longer_top_level::ConflictingSnakeCaseNames_) == 1);
static_assert(CRUBIT_OFFSET_OF(
                  i,
                  struct ::no_longer_top_level::ConflictingSnakeCaseNames_) ==
              0);
...
static_assert(
    sizeof(struct ::no_longer_top_level::ConflictingSnakeCaseNames_::Inner) ==
    1);
static_assert(
...
static_assert(alignof(struct ::no_longer_top_level::OnlyOneHasNestedItems) ==
              1);
static_assert(CRUBIT_OFFSET_OF(
...
static_assert(sizeof(struct ::no_longer_top_level::OnlyOneHasNestedItems_) ==
              1);
static_assert(alignof(struct ::no_longer_top_level::OnlyOneHasNestedItems_) ==
              1);
...
static_assert(CRUBIT_OFFSET_OF(
                  i, struct ::no_longer_top_level::SameNameAsNamespace) == 0);
...
static_assert(
    sizeof(struct ::no_longer_top_level::SameNameAsNamespace::Inner) == 1);
static_assert(
    alignof(struct ::no_longer_top_level::SameNameAsNamespace::Inner) == 1);
...
static_assert(
    sizeof(struct ::no_longer_top_level::same_name_as_namespace::Foo) == 1);
static_assert(
...
static_assert(
    sizeof(struct ::no_longer_top_level::same_name_as_namespace::Bar) == 1);
static_assert(
