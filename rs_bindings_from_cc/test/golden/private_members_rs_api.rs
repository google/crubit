...
pub mod test_namespace_bindings {
    ...
    // Can't generate bindings for test_namespace_bindings::SomeClass::SomeClass, because of missing required features (<internal link>):
    ...
    // Can't generate bindings for test_namespace_bindings::SomeClass::operator=, because of missing required features (<internal link>):
