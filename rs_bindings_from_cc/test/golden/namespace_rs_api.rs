...
pub mod test_namespace_bindings {
    ...
    // Can't generate bindings for test_namespace_bindings::S::S, because of missing required features (<internal link>):
    ...
    // Can't generate bindings for test_namespace_bindings::S::operator=, because of missing required features (<internal link>):
...
pub mod test_namespace_bindings_reopened {
    ...
    pub mod inner {
        ...
        // Can't generate bindings for test_namespace_bindings_reopened::inner::S::S, because of missing required features (<internal link>):
        ...
        // Can't generate bindings for test_namespace_bindings_reopened::inner::S::operator=, because of missing required features (<internal link>):
...
pub mod test_namespace_bindings_inline {
    pub mod inner {
        ...
        // Can't generate bindings for test_namespace_bindings_inline::inner::StructInInlineNamespace::StructInInlineNamespace, because of missing required features (<internal link>):
        ...
        // Can't generate bindings for test_namespace_bindings_inline::inner::StructInInlineNamespace::operator=, because of missing required features (<internal link>):
