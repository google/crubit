...
extern "C" void __rust_thunk___Z15ReturnCppStructv(
  ...
  ::crubit::internal::Encode<struct CppStruct, ::crubit::ByBridge<>>(
      __return_abi_buffer, ReturnCppStruct());
}

extern "C" void __rust_thunk___Z13TakeCppStruct9CppStruct(
    const unsigned char* __param_0) {
  TakeCppStruct(
      ::crubit::internal::Decode<struct CppStruct, ::crubit::ByBridge<>>(
          __param_0));
}
...
extern "C" void __rust_thunk___Z16MakeOptionalVec3fffb(
    ...
    bool is_present) {
  ::crubit::internal::Encode<struct MyOption<Vec3>,
                             ::crubit::ByBridge<::crubit::ByTransmute>>(
...
extern "C" void __rust_thunk___Z11MapMultiply8MyOptionI4Vec3Ef(
  ...
  ::crubit::internal::Encode<struct MyOption<Vec3>,
      ...
      __return_abi_buffer,
      MapMultiply(
          ::crubit::internal::Decode<struct MyOption<Vec3>,
                                     ::crubit::ByBridge<::crubit::ByTransmute>>(
              v),
          factor));
}
