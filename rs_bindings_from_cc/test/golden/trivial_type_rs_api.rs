...
pub mod ns {
    ...
    // Can't generate bindings for ns::Trivial::Trivial, because of missing required features (<internal link>):
    ...
    // Can't generate bindings for ns::Trivial::operator=, because of missing required features (<internal link>):
    ...
    // Can't generate bindings for ns::Trivial::RvalueRefQualified, because of missing required features (<internal link>):
    ...
    // Can't generate bindings for ns::Trivial::ConstRvalueRefQualified, because of missing required features (<internal link>):
    ...
    // Can't generate bindings for ns::TakesByReference, because of missing required features (<internal link>):
    ...
    // Can't generate bindings for ns::TakesByConstReference, because of missing required features (<internal link>):
    ...
    // Can't generate bindings for ns::TakesByRvalueReference, because of missing required features (<internal link>):
    ...
    // Can't generate bindings for ns::TakesByConstRvalueReference, because of missing required features (<internal link>):
