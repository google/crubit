...
///   * `ptrdiff_t_field`: Rust type is unknown; safety requirements cannot be automatically generated: Unsupported type 'decltype(static_cast<int *>(nullptr) - static_cast<int *>(nullptr))': Unsupported clang::Type class 'Decltype'
///   * `size_t_field`: Rust type is unknown; safety requirements cannot be automatically generated: Unsupported type 'decltype(sizeof (0))': Unsupported clang::Type class 'Decltype'
