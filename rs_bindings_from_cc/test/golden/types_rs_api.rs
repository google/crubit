...
pub trait BindingFailedFor_ZN19FieldTypeTestStructC1EOS_ {}
impl<'error, 'b> From<::ctor::RvalueReference<'b, Self>> for FieldTypeTestStruct
where
    &'error (): BindingFailedFor_ZN19FieldTypeTestStructC1EOS_,
{
    #[inline(always)]
    fn from(__param_0: ::ctor::RvalueReference<'b, Self>) -> Self {
