...
pub mod test_namespace_bindings {
    ...
    // Can't generate bindings for test_namespace_bindings::MyTypeAlias, because of missing required features (<internal link>):
    // //rs_bindings_from_cc/test/golden:templates_cc needs [//features:wrapper] for test_namespace_bindings::MyTypeAlias (error: Can't generate bindings for test_namespace_bindings::MyTemplate<int>, because of missing required features (<internal link>):
    ...
    // Can't generate bindings for test_namespace_bindings::OtherTypeAliasInSameTarget, because of missing required features (<internal link>):
    // //rs_bindings_from_cc/test/golden:templates_cc needs [//features:wrapper] for test_namespace_bindings::OtherTypeAliasInSameTarget (error: Can't generate bindings for test_namespace_bindings::MyTemplate<int>, because of missing required features (<internal link>):
    // //rs_bindings_from_cc/test/golden:templates_cc needs [//features:wrapper] for test_namespace_bindings::MyTemplate<int> (crate::__CcTemplateInstN23test_namespace_bindings10MyTemplateIiEE is a template instantiation)
    // //rs_bindings_from_cc/test/golden:templates_cc needs [//features:wrapper] for test_namespace_bindings::MyTemplate<int> (crate::__CcTemplateInstN23test_namespace_bindings10MyTemplateIiEE is a template instantiation))
    ...
    // Can't generate bindings for test_namespace_bindings::TemplateParam::TemplateParam, because of missing required features (<internal link>):
    ...
    // Can't generate bindings for test_namespace_bindings::TemplateParam::operator=, because of missing required features (<internal link>):
    ...
    // Can't generate bindings for test_namespace_bindings::TemplateWithStructTemplateParam, because of missing required features (<internal link>):
    // //rs_bindings_from_cc/test/golden:templates_cc needs [//features:wrapper] for test_namespace_bindings::TemplateWithStructTemplateParam (error: Can't generate bindings for test_namespace_bindings::MyTemplate<test_namespace_bindings::TemplateParam>, because of missing required features (<internal link>):
    ...
    // Can't generate bindings for test_namespace_bindings::ParamFromDifferentScope, because of missing required features (<internal link>):
    // //rs_bindings_from_cc/test/golden:templates_cc needs [//features:wrapper] for test_namespace_bindings::ParamFromDifferentScope (error: Can't generate bindings for test_namespace_bindings::MyTemplate<DifferentScope>, because of missing required features (<internal link>):
    ...
    // Can't generate bindings for test_namespace_bindings::AliasToTemplateWithTwoParams, because of missing required features (<internal link>):
    // //rs_bindings_from_cc/test/golden:templates_cc needs [//features:wrapper] for test_namespace_bindings::AliasToTemplateWithTwoParams (error: Can't generate bindings for test_namespace_bindings::TemplateWithTwoParams<int, float>, because of missing required features (<internal link>):
    ...
    // Can't generate bindings for test_namespace_bindings::AliasToTemplateOfATemplate, because of missing required features (<internal link>):
    // //rs_bindings_from_cc/test/golden:templates_cc needs [//features:wrapper] for test_namespace_bindings::AliasToTemplateOfATemplate (error: Can't generate bindings for test_namespace_bindings::TemplateWithTwoParams<test_namespace_bindings::TemplateWithTwoParams<int, int>, int>, because of missing required features (<internal link>):
    ...
    // Can't generate bindings for test_namespace_bindings::MyCharStruct, because of missing required features (<internal link>):
    // //rs_bindings_from_cc/test/golden:templates_cc needs [//features:wrapper] for test_namespace_bindings::MyCharStruct (error: Can't generate bindings for test_namespace_bindings::MyStruct<char>, because of missing required features (<internal link>):
...
pub mod template_template_params { // Error while generating bindings for class 'template_template_params::Policy':
    ...
    // Can't generate bindings for template_template_params::MyTypeAlias, because of missing required features (<internal link>):
    // //rs_bindings_from_cc/test/golden:templates_cc needs [//features:wrapper] for template_template_params::MyTypeAlias (error: Can't generate bindings for template_template_params::MyTemplate<template_template_params::Policy>, because of missing required features (<internal link>):
...
pub mod forward_declared_template { // Error while generating bindings for class 'forward_declared_template::ForwardDeclaredTemplate':
    ...
    // Can't generate bindings for forward_declared_template::TypeAliasToForwardDeclaredTemplate, because of missing required features (<internal link>):
    // //rs_bindings_from_cc/test/golden:templates_cc needs [//features:wrapper] for forward_declared_template::TypeAliasToForwardDeclaredTemplate (error: Can't generate bindings for forward_declared_template::ForwardDeclaredTemplate<int>, because of missing required features (<internal link>):
...
pub mod private_classes {
    ...
    // Can't generate bindings for private_classes::HasPrivateType::HasPrivateType, because of missing required features (<internal link>):
    ...
    // Can't generate bindings for private_classes::HasPrivateType::operator=, because of missing required features (<internal link>):
