...
pub struct StructWithLifetimeboundMemberFunction {
    ...
    pub(crate) p: [::core::mem::MaybeUninit<u8>; 8],
}
...
pub struct DropClassWithLifetimeboundMemberFunction {
    ...
    /// Reason for representing this field as a blob of bytes:
    /// Types of non-public C++ fields can be elided away
    pub(crate) p: [::core::cell::Cell<::core::mem::MaybeUninit<u8>>; 8],
}
    ...
    fn ctor_new(args: crate::PlainStruct) -> Self::CtorType {
        unsafe {
            ::ctor::FnCtor::new(move |__crubit_dest: *mut Self| {
                let mut s = args;
                let mut s = ::core::mem::MaybeUninit::new(s);
                crate::detail::__rust_thunk___ZN35DropStructWithCtorAndMemberFunctionC1E11PlainStruct(__crubit_dest as*mut::core::ffi::c_void,s.as_mut_ptr());
            })
        }
    }
}
    ...
    fn ctor_new(args: crate::PlainStruct) -> Self::CtorType {
        unsafe {
            ::ctor::FnCtor::new(move |__crubit_dest: *mut Self| {
                let mut s = args;
                let mut s = ::core::mem::MaybeUninit::new(s);
                crate::detail::__rust_thunk___ZN38DropStructWithCtorAndRefMemberFunctionC1E11PlainStruct(__crubit_dest as*mut::core::ffi::c_void,s.as_mut_ptr());
            })
        }
    }
}
...
const _: () = {
    ...
    assert!(::core::mem::size_of::<crate::StructWithLifetimeboundMemberFunction>() == 8);
    assert!(::core::mem::align_of::<crate::StructWithLifetimeboundMemberFunction>() == 8);
    ...
    assert!(::core::mem::offset_of!(crate::StructWithLifetimeboundMemberFunction, p) == 0);
    assert!(::core::mem::size_of::<crate::StructWithLifetimeboundRefMemberFunction>() == 8);
    assert!(::core::mem::align_of::<crate::StructWithLifetimeboundRefMemberFunction>() == 8);
    ...
    assert!(::core::mem::offset_of!(crate::StructWithLifetimeboundRefMemberFunction, p) == 0);
    assert!(::core::mem::size_of::<crate::DropClassWithLifetimeboundMemberFunction>() == 8);
    assert!(::core::mem::align_of::<crate::DropClassWithLifetimeboundMemberFunction>() == 8);
    ...
    assert!(::core::mem::offset_of!(crate::DropClassWithLifetimeboundMemberFunction, p) == 0);
    assert!(::core::mem::size_of::<crate::DropClassWithLifetimeboundRefMemberFunction>() == 8);
    assert!(::core::mem::align_of::<crate::DropClassWithLifetimeboundRefMemberFunction>() == 8);
    ...
    assert!(::core::mem::offset_of!(crate::DropClassWithLifetimeboundRefMemberFunction, p) == 0);
    assert!(::core::mem::size_of::<crate::StructWithLifetimeboundCtor>() == 8);
    assert!(::core::mem::align_of::<crate::StructWithLifetimeboundCtor>() == 8);
    ...
    assert!(::core::mem::offset_of!(crate::StructWithLifetimeboundCtor, p) == 0);
    assert!(::core::mem::size_of::<crate::StructWithLifetimeboundRefCtor>() == 8);
    assert!(::core::mem::align_of::<crate::StructWithLifetimeboundRefCtor>() == 8);
    ...
    assert!(::core::mem::offset_of!(crate::StructWithLifetimeboundRefCtor, p) == 0);
    assert!(::core::mem::size_of::<crate::DropStructWithLifetimeboundCtor>() == 8);
    assert!(::core::mem::align_of::<crate::DropStructWithLifetimeboundCtor>() == 8);
    ...
    assert!(::core::mem::offset_of!(crate::DropStructWithLifetimeboundCtor, p) == 0);
    assert!(::core::mem::size_of::<crate::DropStructWithLifetimeboundRefCtor>() == 8);
    assert!(::core::mem::align_of::<crate::DropStructWithLifetimeboundRefCtor>() == 8);
    ...
    assert!(::core::mem::offset_of!(crate::DropStructWithLifetimeboundRefCtor, p) == 0);
    assert!(::core::mem::size_of::<crate::DropStructWithRefCtorAndRefMemberFunction>() == 8);
    assert!(::core::mem::align_of::<crate::DropStructWithRefCtorAndRefMemberFunction>() == 8);
    ...
    assert!(::core::mem::offset_of!(crate::DropStructWithRefCtorAndRefMemberFunction, p) == 0);
    assert!(::core::mem::size_of::<crate::DropStructWithCtorAndMemberFunction>() == 8);
    assert!(::core::mem::align_of::<crate::DropStructWithCtorAndMemberFunction>() == 8);
    ...
    assert!(::core::mem::offset_of!(crate::DropStructWithCtorAndMemberFunction, p) == 0);
    assert!(::core::mem::size_of::<crate::DropStructWithCtorAndRefMemberFunction>() == 8);
    assert!(::core::mem::align_of::<crate::DropStructWithCtorAndRefMemberFunction>() == 8);
    ...
    assert!(::core::mem::offset_of!(crate::DropStructWithCtorAndRefMemberFunction, p) == 0);
    assert!(::core::mem::size_of::<crate::DropStructWithRefCtorAndMemberFunction>() == 8);
    assert!(::core::mem::align_of::<crate::DropStructWithRefCtorAndMemberFunction>() == 8);
    ...
    assert!(::core::mem::offset_of!(crate::DropStructWithRefCtorAndMemberFunction, p) == 0);
};
